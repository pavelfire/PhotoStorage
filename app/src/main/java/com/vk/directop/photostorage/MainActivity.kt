package com.vk.directop.photostorage
...
import com.vk.directop.photostorage.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val takePhoto = registerForActivityResult(ActivityResultContracts.TakePicturePreview()) { it!!
